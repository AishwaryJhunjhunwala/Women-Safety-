...
const { MapPin, Phone, Clock, AlertTriangle, Shield, Users, BookOpen, Menu } = lucideReact
      ...
      <nav className="sticky top-0 z-50 glass-card border-b border-white/10 px-4 py-4">
        <div className="flex items-center justify-between max-w-6xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <span className="text-white/50">Safety Map</span>
            <span className="text-white/50">Community</span>
            <span className="text-white/50">Awareness</span>
